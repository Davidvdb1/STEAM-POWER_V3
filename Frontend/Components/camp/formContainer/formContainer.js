...
window.customElements.define('form-れ', class extends HTMLElement {
    constructor() {
        ...
        this.camp = null;
        this.message = this._shadowRoot.querySelector("#statusmessage");
        ...
        this.items = [
            ...
            { id: "location", label: "Locatie", type: "select", amountInRow: "one" },
    ...
    connectedCallback() {
        this.message.style= "grid-area: statusmessage;" 
    ...
    async formatAndSendData(campID) {
        ...
        for (const { id } of this.items) {
            ...
            const realInput = input.shadowRoot.querySelector("input, select");
    ...
    async createCamp(data) {
        ...
        try {
            ...
            if (response.ok) {
                ...
                this.updateStatusMessage("❌ Er is een fout opgetreden bij het toevoegen van het kamp.", "error");
            }
        } catch (error) {
