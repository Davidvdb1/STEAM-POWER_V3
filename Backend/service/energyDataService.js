...
class EnergyDataService {
    async create(data) {
        try {
            ...
            await gameStatisticsRepository.incrementGreenEnergyWithMultiplier(currency, greenEnergy, data.type, assetMultiplier, assets); // om factor van groene energiebronnen erin te brengen
