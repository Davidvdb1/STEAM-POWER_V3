  ...
  describe("Game Statistics Operations", () => {
    ...
    describe("GET /gameStatistics", () => {
      it("should get all game statistics", async () => {
        ...
        gameStatisticsService.getAllGameStatistics.mockResolvedValue(
          mockGameStatistics
        );
      ...
      it("should handle errors when getting all game statistics", async () => {
        gameStatisticsService.getAllGameStatistics.mockRejectedValue(
    ...
    describe("GET /gameStatistics/group/:groupId", () => {
      it("should fetch game statistics by group ID", async () => {
        ...
        expect(res.statusCode).toBe(200);
        expect(res.body).toEqual(mockData);
        expect(gameStatisticsService.getByGroupId).toHaveBeenCalledWith(
          "group-1"
        );
      });
  ...
  describe("Currency Operations", () => {
    describe("GET /gameStatistics/:id/currency", () => {
      it("should get currency by ID", async () => {
        ...
        expect(gameStatisticsService.getCurrencyById).toHaveBeenCalledWith(
          "gs-1"
        );
      });
      ...
      it("should return 404 if currency not found", async () => {
        ...
        const res = await request(app).get(
          "/gameStatistics/nonexistent/currency"
        );
    ...
    describe("PUT /gameStatistics/:id/currency", () => {
      it("should update currency", async () => {
        ...
        expect(gameStatisticsService.updateCurrency).toHaveBeenCalledWith(
          "gs-1",
          { coins: 50 }
        );
      });
      ...
      it("should handle currency update errors", async () => {
        gameStatisticsService.updateCurrency.mockRejectedValue(
          new Error("Invalid currency values")
        );
    ...
    describe("POST /gameStatistics/:id/currency/increment", () => {
      it("should increment currency", async () => {
        ...
        gameStatisticsService.incrementCurrency.mockResolvedValue(
          incrementedCurrency
        );
        ...
        expect(gameStatisticsService.incrementCurrency).toHaveBeenCalledWith(
          "gs-1",
          { coins: 10 }
        );
      });
  ...
  describe("Asset Operations", () => {
    describe("POST /gameStatistics/:id/assets", () => {
      it("should add an asset", async () => {
        ...
        expect(res.statusCode).toBe(201);
        expect(res.body).toEqual(mockResponse);
        expect(gameStatisticsService.addAsset).toHaveBeenCalledWith(
          "gs-1",
          assetData
        );
      });
      ...
      it("should handle asset creation errors", async () => {
        gameStatisticsService.addAsset.mockRejectedValue(
  ...
  describe("Checkpoint Operations", () => {
    describe("POST /gameStatistics/:id/checkpoints", () => {
      it("should record a checkpoint", async () => {
        ...
        gameStatisticsService.recordCheckpoint.mockResolvedValue(
          mockCheckpoint
        );

        const res = await request(app).post("/gameStatistics/gs-1/checkpoints");

        expect(res.statusCode).toBe(201);
        expect(res.body).toEqual(mockCheckpoint);
        expect(gameStatisticsService.recordCheckpoint).toHaveBeenCalledWith(
          "gs-1"
        );
      });

      it("should handle checkpoint creation errors", async () => {
        gameStatisticsService.recordCheckpoint.mockRejectedValue(
          new Error("Cannot create checkpoint")
        );
    ...
    describe("GET /gameStatistics/:id/checkpoints", () => {
      it("should get all checkpoints for game statistics", async () => {
        ...
        gameStatisticsService.findAllCheckpointsByGameStatisticsId.mockResolvedValue(
          mockCheckpoints
        );
        ...
        expect(
          gameStatisticsService.findAllCheckpointsByGameStatisticsId
    ...
    describe("DELETE /gameStatistics/checkpoints/:checkpointId", () => {
      it("should remove a checkpoint", async () => {
        ...
        const res = await request(app).delete(
          "/gameStatistics/checkpoints/cp-1"
        );

        expect(res.statusCode).toBe(200);
        expect(res.body.message).toBe("Checkpoint removed");
        expect(gameStatisticsService.removeCheckpoint).toHaveBeenCalledWith(
          "cp-1"
        );
      });
    });
    ...
    describe("PUT /gameStatistics/refactor/:checkpointId", () => {
      it("should refactor game statistics from checkpoint", async () => {
        ...
        gameStatisticsService.refactorGameStatistics.mockResolvedValue(
          mockGameStatistics
        );
        ...
        expect(res.body).toEqual(mockGameStatistics);
        expect(
          gameStatisticsService.refactorGameStatistics
  ...
  describe("Game Building Operations", () => {
    describe("PUT /gameStatistics/buildings/:gameBuildingId/upgrade", () => {
      it("should upgrade a game building", async () => {
        ...
        gameStatisticsService.upgradeGameBuilding.mockResolvedValue(
          mockResponse
        );
        ...
        expect(res.statusCode).toBe(200);
        expect(res.body).toEqual(mockResponse);
        expect(gameStatisticsService.upgradeGameBuilding).toHaveBeenCalledWith(
          "gb-1",
          { nextLevel: 2 }
        );
      });
      ...
      it("should handle building upgrade errors", async () => {
        gameStatisticsService.upgradeGameBuilding.mockRejectedValue(
    ...
    describe("GET /gameStatistics/gameBuildings/getAllGameBuildingsByGroupId/:groupId", () => {
      it("should get all game buildings by group ID", async () => {
        ...
        gameStatisticsService.getAllGameBuildingsByGroupId.mockResolvedValue(
          mockBuildings
        );

        const res = await request(app).get(
          "/gameStatistics/gameBuildings/getAllGameBuildingsByGroupId/group-1"
        );

        expect(res.statusCode).toBe(200);
        expect(res.body).toEqual(mockBuildings);
        expect(
          gameStatisticsService.getAllGameBuildingsByGroupId
    ...
    describe("PUT /gameStatistics/buildings/:gameBuildingId/green", () => {
      it("should toggle building runs on green", async () => {
        ...
        gameStatisticsService.toggleGameBuildingRunsOnGreen.mockResolvedValue(
          mockBuilding
        );

        const res = await request(app).put(
          "/gameStatistics/buildings/gb-1/green"
        );

        expect(res.statusCode).toBe(200);
        expect(res.body).toEqual(mockBuilding);
        expect(
          gameStatisticsService.toggleGameBuildingRunsOnGreen
    ...
    describe("POST /gameStatistics/gameBuildings/:gameStatisticsId", () => {
      it("should create game buildings", async () => {
        const mockBuildings = [{ id: "gb-1" }, { id: "gb-2" }];
        gameStatisticsService.createGameBuildings.mockResolvedValue(
          mockBuildings
        );

        const res = await request(app).post(
          "/gameStatistics/gameBuildings/gs-1"
        );

        expect(res.statusCode).toBe(201);
        expect(res.body).toEqual(mockBuildings);
        expect(gameStatisticsService.createGameBuildings).toHaveBeenCalledWith(
          "gs-1"
        );
      });
    });
  ...
  describe("Achievement Operations", () => {
    describe("POST /gameStatistics/achievements/add/:gameStatisticsId/:title", () => {
      it("should add achievement to game statistics", async () => {
        const mockGameStatistics = {
          id: "gs-1",
          achievements: [{ title: "Test Achievement" }],
        };
        gameStatisticsService.addAchievementToGameStatistics.mockResolvedValue(
          mockGameStatistics
        );

        const res = await request(app).post(
          "/gameStatistics/achievements/add/gs-1/Test Achievement"
        );
        ...
        ).toHaveBeenCalledWith("gs-1", "Test Achievement");
      });

      it("should handle achievement addition errors", async () => {
        gameStatisticsService.addAchievementToGameStatistics.mockRejectedValue(
          new Error("Achievement not found")
        );

        const res = await request(app).post(
          "/gameStatistics/achievements/add/gs-1/Invalid Achievement"
        );
    ...
    describe("GET /gameStatistics/:gameStatisticsId/achievements", () => {
      it("should get game statistics achievements", async () => {
        ...
        gameStatisticsService.getGameStatisticsAchievements.mockResolvedValue(
          mockAchievements
        );

        const res = await request(app).get("/gameStatistics/gs-1/achievements");

        expect(res.statusCode).toBe(200);
        expect(res.body).toEqual(mockAchievements);
        expect(
          gameStatisticsService.getGameStatisticsAchievements
        ).toHaveBeenCalledWith("gs-1");
      });
    });
    ...
    describe("GET /gameStatistics/:gameStatisticsId/achievements/check/:title", () => {
      it("should check if achievement has been achieved", async () => {
        ...
        gameStatisticsService.hasAchievementBeenAchieved.mockResolvedValue(
          true
        );

        const res = await request(app).get(
          "/gameStatistics/gs-1/achievements/check/Test Achievement"
        );
        ...
        expect(gameStatisticsService.getById).toHaveBeenCalledWith("gs-1");
        expect(
          gameStatisticsService.hasAchievementBeenAchieved
        ).toHaveBeenCalledWith(mockGameStatistics, "Test Achievement");
      });
      ...
      it("should return 404 if game statistics not found", async () => {
        ...
        const res = await request(app).get(
          "/gameStatistics/nonexistent/achievements/check/Test Achievement"
        );
