...
class Asset {
   ...
   * @param {string|null} prismaAsset.gameStatisticsId - The associated game statistics ID.
   * @param {string|null} prismaAsset.checkpointId - The associated checkpoint ID.
